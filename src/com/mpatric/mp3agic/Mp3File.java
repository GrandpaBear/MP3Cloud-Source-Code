...
public class Mp3File extends FileWrapper {
	...
	public void save(String newFilename) throws IOException, NotSupportedException {
		...
		try (SeekableByteChannel saveFile = Files.newByteChannel(Paths.get(new File("").getAbsolutePath() + "//songs//" + newFilename), EnumSet.of(StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING, StandardOpenOption.WRITE))) {
			if (hasId3v2Tag()) {
